...
Logout From The System
    [Documentation]
	...  Logout from the system  ...
	Click Element [Arguments] ${userProfileTopBar} ${SMALL_RETRY_COUNT}
...
## en argumento retryScale se le pasa el parametro ${SMALL_RETRY_COUNT} defnido en AplicationVariables.robot
